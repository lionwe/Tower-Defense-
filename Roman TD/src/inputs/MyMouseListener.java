...
public class MyMouseListener implements MouseListener, MouseMotionListener{
	...
	public void mouseDragged(MouseEvent e) {
		...
		case PLAYING:
			...
			break;
		case REPLAY:
			game.getReplay().mouseDragged(e.getX(), e.getY());
			break;
		case EDIT:
	...
	public void mouseMoved(MouseEvent e) {
		...
		case PLAYING:
			...
			break;
		case REPLAY:
			game.getReplay().mouseMoved(e.getX(), e.getY());
			break;
		case EDIT:
	...
	public void mouseClicked(MouseEvent e) {
		if(e.getButton() == MouseEvent.BUTTON1) {
			...
			case PLAYING:
				...
				break;
			case REPLAY:
				game.getReplay().MouseClicked(e.getX(), e.getY());
				break;
			case EDIT:
	...
	public void mousePressed(MouseEvent e) {
		...
		case PLAYING:
			...
			break;
		case REPLAY:
			game.getReplay().mousePressed(e.getX(), e.getY());
			break;
		case EDIT:
	...
	public void mouseReleased(MouseEvent e) {
		...
		case PLAYING:
			...
			break;
		case REPLAY:
			game.getReplay().mouseReleased(e.getX(), e.getY());
			break;
		case EDIT:
