...
public class LoadSave {
	...
	public static String homePath = "P:\\lionwe\\";
	public static String saveFolder = "Roman TD";
	...
	public static void CreateFile(int[] idArr) {
		if (lvlFile.exists()) {
			...
			WriteToFile(idArr, new RoadPoint(0, 0), new RoadPoint(0, 0));
		}
	...
	private static void WriteToFile(int[] idArr, RoadPoint start, RoadPoint end) {
		try {
	...
	public static void SaveLevel(int[][] idArr, RoadPoint start, RoadPoint end) {
		if (lvlFile.exists()) {
	...
	public static ArrayList<RoadPoint> GetLevelRoadPoints() {
		if (lvlFile.exists()) {
			ArrayList<Integer> list = ReadFromFile();
			ArrayList<RoadPoint> points = new ArrayList<>();
			points.add(new RoadPoint(list.get(400), list.get(401)));
			points.add(new RoadPoint(list.get(402), list.get(403)));
